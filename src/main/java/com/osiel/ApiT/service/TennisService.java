...
public class TennisService {
    ...
    private final List<Tennis> tenisList = Arrays.asList(
            // Nike
    ...
    public List<Tennis> getTennisForMark(String marca){
        return tenisList.stream()
                .filter(tennis -> tennis.getMark().equalsIgnoreCase(marca))
    ...
    public Tennis getTennisForName(String nome){
        ...
        .filter(tennis -> tennis.getName().equalsIgnoreCase(nome))
                .findFirst()
